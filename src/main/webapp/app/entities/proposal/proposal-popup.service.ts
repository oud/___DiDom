    ...
    open(component: Component, id?: number | any): NgbModalRef {
        ...
        if (id) {
            this.proposalService.find(id).subscribe((proposal) => {
                proposal.proposalTime = this.datePipe
                    .transform(proposal.proposalTime, 'yyyy-MM-ddThh:mm');
                this.proposalModalRef(component, proposal);
            });
        } else {
            return this.proposalModalRef(component, new Proposal());
        }
    }
